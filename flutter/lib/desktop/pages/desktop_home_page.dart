...
class _DesktopHomePageState extends State<DesktopHomePage>
  ...
  void _showBindDeviceDialog(BuildContext context) {
    ...
    final deviceUsernameController = TextEditingController(
      text: bind.mainGetOptionSync(key: 'preset-device-username'),
    );
        ...
        builder: (ctx, setState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              TextField(
                controller: deviceUsernameController,
                decoration: InputDecoration(
                  labelText: '用户名',
                  hintText: '请输入用户信息',
                ),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                bind.mainSetOption(
                  key: 'preset-device-username',
                  value: deviceUsernameController.text.trim(),
                );
                bind.mainSetOption(
