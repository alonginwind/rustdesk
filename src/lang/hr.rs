...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na MiraConn mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a MiraConn ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate MiraConn na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, MiraConn-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, MiraConn-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti MiraConn-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [MiraConn Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep MiraConn background service", "Zadrži MiraConn kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje MiraConn aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show MiraConn", "Prikaži MiraConn"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti MiraConnu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti MiraConnu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog MiraConna."),
        ...
        ("verify_miraconn_password_tip", "Provjera lozinke za MiraConn"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete MiraConn, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_miraconn_server_pro_to_{}_tip", "Ažurirajte MiraConn Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti MiraConn da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće MiraConn"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor MiraConna otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa MiraConna"),
        ...
        ("upgrade_remote_miraconn_client_to_{}_tip", "Molimo ažurirajte MiraConn klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, MiraConn provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, MiraConn će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, MiraConn više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: MiraConn poslužitelj OSS ne uključuje ovu značajku."),
