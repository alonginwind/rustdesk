...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "MiraConni võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa MiraConn mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et MiraConn oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb MiraConnile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb MiraConnile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma MiraConnile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [MiraConn Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep MiraConn background service", "Säilita MiraConni taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele MiraConni rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma MiraConnile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma MiraConnile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud MiraConni kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_miraconn_password_tip", "Kinnita MiraConni parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul MiraConni kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_miraconn_server_pro_to_{}_tip", "Palun täienda MiraConn Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib MiraConnil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb MiraConnil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui MiraConni aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada MiraConni taustateenust."),
        ...
        ("About MiraConn", "MiraConni teave"),
        ...
        ("upgrade_remote_miraconn_client_to_{}_tip", "Täiendage MiraConni klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib MiraConn TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab MiraConn kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta MiraConn enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: MiraConni serveri OSS ei sisalda seda funktsiooni."),
