...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "RemoteSQi võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa RemoteSQ mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et RemoteSQ oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb RemoteSQile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb RemoteSQile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma RemoteSQile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [RemoteSQ Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RemoteSQ background service", "Säilita RemoteSQi taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele RemoteSQi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma RemoteSQile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma RemoteSQile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud RemoteSQi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_remotesq_password_tip", "Kinnita RemoteSQi parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul RemoteSQi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_remotesq_server_pro_to_{}_tip", "Palun täienda RemoteSQ Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib RemoteSQil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb RemoteSQil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui RemoteSQi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada RemoteSQi taustateenust."),
        ...
        ("About RemoteSQ", "RemoteSQi teave"),
        ...
        ("upgrade_remote_remotesq_client_to_{}_tip", "Täiendage RemoteSQi klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib RemoteSQ TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab RemoteSQ kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta RemoteSQ enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: RemoteSQi serveri OSS ei sisalda seda funktsiooni."),
