...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the RemoteSQ network..."),
        ...
        ("install_tip", "Due to UAC, RemoteSQ can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install RemoteSQ to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant RemoteSQ \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant RemoteSQ \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow RemoteSQ to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [RemoteSQ Input] service."),
        ...
        ("doc_mac_permission", "https://remotesq.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next RemoteSQ application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant RemoteSQ \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant RemoteSQ \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running RemoteSQ."),
        ...
        ("verify_remotesq_password_tip", "Verify RemoteSQ password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use RemoteSQ and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_remotesq_server_pro_to_{}_tip", "Please upgrade RemoteSQ Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://remotesq.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent RemoteSQ from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by RemoteSQ"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if RemoteSQ window is open"),
        ...
        ("floating_window_tip", "It helps to keep RemoteSQ background service"),
        ...
        ("upgrade_remote_remotesq_client_to_{}_tip", "Please upgrade the RemoteSQ client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, RemoteSQ verifies the server certificate for protocols using TLS.\nWith this option enabled, RemoteSQ will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, RemoteSQ will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: RemoteSQ server OSS doesn't include this feature."),
