...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de MiraConn..."),
        ...
        ("install_tip", "En alguns casos és possible que el MiraConn no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el MiraConn al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al MiraConn els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al MiraConn els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al MiraConn l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «MiraConn Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep MiraConn background service", "Manté el servei del MiraConn en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del MiraConn, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("Show MiraConn", "Mostra el MiraConn"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al MiraConn els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al MiraConn els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del MiraConn en execució."),
        ...
        ("verify_miraconn_password_tip", "Verifica la contrasenya del MiraConn"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del MiraConn, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_miraconn_server_pro_to_{}_tip", "Actualitzeu el MiraConn Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el MiraConn funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de MiraConn"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del MiraConn està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del MiraConn en rerefons"),
        ...
        ("About MiraConn", "Quant al MiraConn"),
        ...
        ("upgrade_remote_miraconn_client_to_{}_tip", "Actualitzeu el client MiraConn a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el MiraConn verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el MiraConn ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el MiraConn ja no utilitzarà l'UDP 21116, sinó que utilitzarà el TCP 21116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El MiraConn Server OSS no inclou aquesta característica."),
