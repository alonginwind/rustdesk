...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua MiraConn..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca MiraConn să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala MiraConn."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți MiraConn acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți MiraConn acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți MiraConn să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [MiraConn Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep MiraConn background service", "Rulează serviciul MiraConn în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației MiraConn, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show MiraConn", "Afișează MiraConn"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi MiraConn permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi MiraConn permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din MiraConn care rulează."),
        ...
        ("verify_miraconn_password_tip", "Verifică parola MiraConn"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi MiraConn pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_miraconn_server_pro_to_{}_tip", "Versiunea serverului MiraConn Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul MiraConn pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu MiraConn"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web MiraConn Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări MiraConn. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About MiraConn", "Despre MiraConn"),
        ...
        ("web_id_input_tip", "Introdu ID-ul MiraConn al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_miraconn_client_to_{}_tip", "Versiunea clientului MiraConn de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește MiraConn Pro pentru funcționalitate completă."),
