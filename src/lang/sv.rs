...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till RemoteSQ..."),
        ...
        ("install_tip", "På grund av UAC, kan inte RemoteSQ fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera RemoteSQ på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge RemoteSQ \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge RemoteSQ \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [RemoteSQ Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RemoteSQ background service", "Behåll RemoteSQ i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa RemoteSQ programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge RemoteSQ behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge RemoteSQ behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för RemoteSQ."),
        ...
        ("verify_remotesq_password_tip", "Verifiera RemoteSQ-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda RemoteSQ och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_remotesq_server_pro_to_{}_tip", "Uppgradera RemoteSQ Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra RemoteSQ från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av RemoteSQ"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om RemoteSQ-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla RemoteSQ-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_remotesq_client_to_{}_tip", "Uppgradera RemoteSQ-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar RemoteSQ serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar RemoteSQ över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder RemoteSQ inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: RemoteSQ server OSS inkluderar inte denna funktion."),
